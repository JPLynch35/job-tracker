...
describe "A User" do
  before :each do
    ...
    @job_11 = @company_1.jobs.create(title: "Developer", level_of_interest: 70, city: "Denver", category_id: @category_1.id)
    @job_12 = @company_1.jobs.create(title: "QA Analyst", level_of_interest: 70, city: "New York City", category_id: @category_2.id)
    @company_2 = Company.create(name: "Apple")
    @job_21 = @company_2.jobs.create(title: "Manager", level_of_interest: 70, city: "Denver", category_id: @category_1.id)
